...
var Icon$r = function (props) {
    return (React.createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", width: "40", height: "40", viewBox: "0 0 100 100" }, props),
        React.createElement("g", { transform: "translate(143.673 -171.512)" },
            React.createElement("circle", { cx: -98.673, cy: 216.512, r: 45, fill: "#d8e1f6" }),
            React.createElement("path", { d: "M-89.255 227.791h5.144l8.756-16.187h-5.144zm-7.58 14.01c-.55 1.018-1.442 1.128-1.8 1.128h-.001c-.359 0-1.25-.11-1.8-1.125l-9.507-17.516h-5.148l10.864 20.017c1.188 2.19 3.277 3.496 5.59 3.496h.005c2.316-.002 4.406-1.312 5.592-3.504l4.723-8.732h-5.144zm25.65-45.004c-1.173-2.277-3.291-3.636-5.666-3.636h-43.641c-2.377 0-4.496 1.36-5.668 3.64a7.736 7.736 0 00.077 7.233l6.772 12.48h5.15l-8.131-14.98a2.471 2.471 0 01-.025-2.33c.181-.352.722-1.172 1.825-1.172h43.64c1.103 0 1.644.819 1.825 1.17a2.471 2.471 0 01-.022 2.328l-1.245 2.3h5.137a7.736 7.736 0 00-.028-7.033", fill: "#fcbe0c" }),
            React.createElement("path", { d: "M-72.626 210.157h-34.473c-1.22 0-2.21-1.09-2.21-2.435s.99-2.436 2.21-2.436h34.473c1.22 0 2.21 1.09 2.21 2.436 0 1.345-.99 2.435-2.21 2.435", fill: "#5975b8" }),
            React.createElement("path", { d: "M-97.958 222.896h-22.646c-1.22 0-2.209-1.09-2.209-2.435s.989-2.436 2.209-2.436h22.646c1.22 0 2.208 1.09 2.208 2.436 0 1.345-.988 2.435-2.208 2.435", fill: "#fcbe0c" }),
            React.createElement("path", { d: "M-84.093 234.112h-15.4c-1.22 0-2.21-1.09-2.21-2.436 0-1.345.99-2.435 2.21-2.435h15.4c1.22 0 2.21 1.09 2.21 2.435 0 1.346-.99 2.436-2.21 2.436", fill: "#5975b8" }))));
};

var Icon$s = function (props) {
    return (React.createElement("svg", __assign({ xmlns: "http://www.w3.org/2000/svg", width: "90", height: "90", viewBox: "0 0 90 90" }, props),
        React.createElement("g", { transform: "translate(143.673 -171.512)" },
            React.createElement("circle", { cx: -98.673, cy: 216.512, r: 45, fill: "#d8e1f6" }),
            React.createElement("path", { d: "M-89.255 227.791h5.144l8.756-16.187h-5.144zm-7.58 14.01c-.55 1.018-1.442 1.128-1.8 1.128h-.001c-.359 0-1.25-.11-1.8-1.125l-9.507-17.516h-5.148l10.864 20.017c1.188 2.19 3.277 3.496 5.59 3.496h.005c2.316-.002 4.406-1.312 5.592-3.504l4.723-8.732h-5.144zm25.65-45.004c-1.173-2.277-3.291-3.636-5.666-3.636h-43.641c-2.377 0-4.496 1.36-5.668 3.64a7.736 7.736 0 00.077 7.233l6.772 12.48h5.15l-8.131-14.98a2.471 2.471 0 01-.025-2.33c.181-.352.722-1.172 1.825-1.172h43.64c1.103 0 1.644.819 1.825 1.17a2.471 2.471 0 01-.022 2.328l-1.245 2.3h5.137a7.736 7.736 0 00-.028-7.033", fill: "#fcbe0c" }),
            React.createElement("path", { d: "M-72.626 210.157h-34.473c-1.22 0-2.21-1.09-2.21-2.435s.99-2.436 2.21-2.436h34.473c1.22 0 2.21 1.09 2.21 2.436 0 1.345-.99 2.435-2.21 2.435", fill: "#5975b8" }),
